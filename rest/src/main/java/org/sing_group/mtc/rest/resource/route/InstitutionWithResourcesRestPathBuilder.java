...
public class InstitutionWithResourcesRestPathBuilder extends InstitutionRestPathBuilder {
  ...
  public TherapistRestPathBuilder therapist(String login) {
    return new TherapistRestPathBuilder(this.builder, login);
  }
  
  public ManagerRestPathBuilder manager() {
    return new ManagerRestPathBuilder(this.builder);
  }
}
