...
import org.sing_group.mtc.domain.entities.session.GamesSessionDataset;
...
public class GamesSessionResourceSecurityTest {
  ...
  @InSequence(111)
  @UsingDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  public void beforeCreateAsAnonymous() {}
  
  @Test
  @InSequence(112)
  @RunAsClient
  public void testCreateAsAnonymous(
    @ArquillianResteasyResource(BASE_PATH) ResteasyWebTarget webTarget
  ) {
    this.testCreate(webTarget, hasUnauthorizedStatus());
  }
  ...
  @ShouldMatchDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  @CleanupUsingScript({ "cleanup.sql", "cleanup-autoincrement.sql" })
  public void afterCreateAsAnonymous() {}

  @Test
  @InSequence(121)
  @UsingDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  public void beforeCreateAsAdmin() {}
  ...
  public void testCreateAsAdmin(
    ...
    this.testCreate(webTarget, hasForbiddenStatus());
  }
  ...
  @ShouldMatchDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  @CleanupUsingScript({ "cleanup.sql", "cleanup-autoincrement.sql" })
  public void afterCreateAsAdmin() {}

  @Test
  @InSequence(131)
  @UsingDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  public void beforeCreateAsPatient() {}
  
  @Test
  @InSequence(132)
  @RunAsClient
  @Header(name = "Authorization", value = UsersDataset.PATIENT1_HTTP_BASIC_AUTH)
  public void testCreateAsPatient(
    @ArquillianResteasyResource(BASE_PATH) ResteasyWebTarget webTarget
  ) {
    this.testCreate(webTarget, hasForbiddenStatus());
  }
  ...
  @ShouldMatchDataSet({ "users.xml", "games.xml", "games-sessions.xml" })
  @CleanupUsingScript({ "cleanup.sql", "cleanup-autoincrement.sql" })
  public void afterCreateAsPatient() {}
  ...
  public void testCreate(ResteasyWebTarget webTarget, HasHttpStatus statusMatcher) {
